#define PROG_NAME "PMD_MQTTReady"
// Author: Nagham Kheir
// Date: 20250316
// A PMD MQTTReady, Similar to WiFiReady but with MQTT including WIT.
// Understanding MQTT for Telemetery #37, and Get GPAD API Firmware Compiling on ESP32, SPI, MQTT #44 and MQTT Provides for LWAT (Last Will and Testament) message, The PMD and the Krake should each take full advantage of LWAT #67 and Inappropriate MQTT Connection Attempt even when WiFi:STA Fails, V0.19 #85 and Firmware, Extend Functionality of LED_BUILTIN, Double Wink on WiFi Connect, Tripple Wink on MQTT Connect #93
// This device will publish MQTT messages when we push any of the 5 memontary switch (buttons). SW1-SW4, Boot.
...
#define MODEL_NAME "Model: PMD_MQTTReady"
