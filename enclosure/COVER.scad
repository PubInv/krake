...
color("red"){cover(30,50,2);}
translate([-1,0,0])cube([50,30,2]); 
}


difference(){
translate([0,0.3,0])color("red"){cover(30-0.6,50-0.6,2);}
...
difference(){
translate([46,18,15])rotate([90,90,0])lock_m();
...
translate([46+5,15-2.5-0.3,2])cube([3,7,3]);
        ...
        translate([46,18,15])    translate([4.5,-2.5,-11.7])
