...
test_part();
translate([2,8.5,2-0.1])numbering(0.8+0.1,4,PartNumber =partNunmber );
    translate([2,2,2-0.1])numbering(0.8+0.1,4,PartNumber =batch);
    



module numbering(t, s, PartNumber)
    {
        linear_extrude(t)
text(str("K_",PartNumber),size = s,font = "Arial Rounded MT Bold:style=Bold");  
